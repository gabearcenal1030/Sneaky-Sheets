...
<body>
    ...
    <section class="dashboard-welcome">
        <h2>Welcome back, 
            <span style="color:#00eaff;">
                <?= isset($_SESSION['username']) ? $_SESSION['username'] : "Gamer"; ?>
            </span>!
        </h2>
        <p>Heres your personalized dashboard. Explore, shop, and stay up-to-date with the latest gaming items.</p>
    </section>
    ...
    <section class="recommended">
        ...
        <div class="recommend-grid">
            ...
            <div class="game-card">
                <img src="eldenring.avif" alt="Game 1">
                <p>Elden Ring</p>
            </div>
